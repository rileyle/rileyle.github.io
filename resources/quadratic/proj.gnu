...
set xlabel "t [s]" 0.000000,0.000000  ""
set x2label "" 0.000000,0.000000  ""
set timefmt "%d/%m/%y\n%H:%M"
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "y [m]" 0.000000,0.000000  ""
...
set locale "C"
set nokey
plot [0:1.5] [-2:1.5] -4.9*x**2 + 5*x - 1,0
set terminal fig color metric thickness 2 fontsize 18
set output 'proj.orig.fig'
replot
set terminal x11
set output
#    EOF
